...
@section('content')
    <div class="flex flex-col items-center pb-10">
        ...
        <h5 class="mb-1 text-xl font-semibold text-black py-3">Edit Data Kelas</h5>
            ...
            <div class="input-body">
                ...
                <form method="post" action="{{ route('data-kelas.update', $kelas->idKelas) }}" id="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kelas" value="{{$kelas->nama_kelas}}" class="form-control" id="nama_kelas" aria-describedby="nama_kelas" class="formcontrol bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-logo focus:border-green-logo block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                    <div class="form-group">
