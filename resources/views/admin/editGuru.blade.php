    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <div class="max-w-sm py-3 px-20 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="input-body">
                ...
                @endif
                <form method="post" action="{{ route('data-guru.update', $Guru->nip) }}" id="myForm" enctype="multipart/form-data">
                    @csrf    
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" id="image" value="{{asset('storage/'.$Guru->foto)}}" aria-describedby="foto" class="formcontrol bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-logo focus:border-green-logo block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
