            ...
            <div class="input-body">
                ...
                <form method="post" action="{{ route('data-guru.update', $Guru->nip) }}" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="foto" id="foto" value="{{asset('storage/'.$Guru->foto)}}" aria-describedby="foto" class="formcontrol bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-logo focus:border-green-logo block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
