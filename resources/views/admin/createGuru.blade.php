            ...
            <div class="input-body">
                ...
                <form method="post" action="{{ route('data-guru.store') }}" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" id="image" aria-describedby="image" class="formcontrol bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-logo focus:border-green-logo block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                    <div class="form-group">
