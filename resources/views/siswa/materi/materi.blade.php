    ...
    <div class="flex flex-wrap -mx-6">
        <div class="p-6 sm:w-1/2 xl:w-3/4">
            <div class="flex px-5 py-6 bg-white">
                <div class="p-2">
                    <center><h1>Klasifikasi Hewan</h1></center><br>
                    ...
                    <h6>Pembagian Klasifikasi Hewan</h6>
                    <center>
                    <img class="w-75 h-30" src="{{asset('storage/image/gambarMateri/bagan1.jpg')}}" alt="">
                    </center><br>
                    Hewan yang terdapat di muka bumi ini sangat beragam, baik dari segi bentuk maupun ukurannya. 
                    Secara umum hewan dapat diklasifikasikan menjadi 2 yaitu hewan vertebrata (bertulang belakang) 
